...
export class Backend implements backendInterface {
    ...
    async createCertificate(arg0: Certificate): Promise<CertificateId> {
        if (this.processError) {
            try {
    ...
    async getCertificate(arg0: CertificateId): Promise<Certificate> {
        if (this.processError) {
            try {
    ...
    async listCertificates(): Promise<Array<Certificate>> {
        if (this.processError) {
            try {
                const result = await this.actor.listCertificates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCertificate(arg0: CertificateId, arg1: Certificate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCertificate(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
